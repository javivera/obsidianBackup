>[!Definition] Extension de funcional
...
>$X$ espacio vectorial real y $p : X\rightarrow \mathbb{R}$ [[Teórico 10#^dafca5]]. Supongamos $\exists W\subseteq X$ subespacio y $f_{W}:W\rightarrow\mathbb{R}$ lineal tal que $f_{W}(w)\leq p(w)\quad\forall w\in W$ 
>Entonces $\exists f_{X}:X\rightarrow\mathbb{R}$ extension (siempre lineal, por definición) de $f_{W}$ tal que $f_{X}(x)\leq p(x)\quad\forall x\in X$
>>[!Proof]
...
>[!Remark]
>$-p(-x)\leq -f_{X}(-x)=f_{X}(x)\leq p(x)\quad\forall x\in X$ 
...
>[!Lemma] Descomposicion de funcional en parte real e imaginaria
...
>>[!Proof]-
>>- (Existencia)
>>	1. Dado $v\in V$ escribimos $g(v)=g_{\mathbb{R}}(v)+ig_{\mathbb{I}}(v)$. Con $g_{\mathbb{R}}(v)=Re(g(v))$ y$g_{\mathbb{I}}(v)=Im(g(v))$ que son funcionales lineales. Claramente $Imagen(g_{\mathbb{R}})\subseteq \mathbb{R}$ analogo $Imagen(g_{\mathbb{I}})$ 
>>	2. $g_{\mathbb{R}}(iv)+ig_{\mathbb{I}}(iv)=g(iv)=ig(v)=ig_{\mathbb{R}}(v)-g_{\mathbb{I}}(v)$
>>	3. $-g_{\mathbb{R}}(iv)=g_{\mathbb{I}}(v)$ (igualando partes reales)
...
>>	- ($\Leftarrow$)
>> 		1. Supongamos $g_{\mathbb{R}}\in (V_{\mathbb{R}})'$ y sea $\alpha=\alpha(v)\in \mathbb{C}$ tal que $\lvert \alpha  \rvert=1$ y $\lvert g(v) \rvert=\alpha g(v)=g(\alpha v)$ 
...
>>	2. Dado el $x$ fijo $\lVert x \rVert=\delta$ de la demo por que $W=\{ 0 \}$  entonces $f(x)=\delta =\lVert x \rVert$ 
>>- (b) 
