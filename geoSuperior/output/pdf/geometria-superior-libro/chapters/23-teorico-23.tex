...
% Source: Teoricos/GS - Teo23.md
\chapter{Distribuciones y teorema de Frobenius}
\label{ch:teo-23}
...
\end{bookremark}
\begin{bookdefinition}{Distribucion}
...
\end{bookdefinition}
\begin{bookdefinition}{Suavidad de Distribucion}
...
\end{bookremark}
\begin{bookdefinition}{Distribucion integrable}
...
\end{bookdefinition}
\begin{bookremark}{Dibujo ultil para entender}
...
\bookimage{assets/pasted-image-20260603132446.png}{Pasted image 20260603132446}


\end{bookremark}
\begin{bookexample}{}
Sea $X$ un campo suave que nunca se anula. Entonces $X$ genera una distribucion suave

\[
\mathcal D_p=\operatorname{span}\{X_p\}.
\]
...
\[
\mathcal D_q=\operatorname{span}\left\{\frac{\partial}{\partial x_1}\bigg|_q,\ldots,\frac{\partial}{\partial x_k}\bigg|_q\right\},
\]
este tiene ejemplo de subvariedades integrales para esta distribucion.
...
\[
\mathcal D_q=\operatorname{span}\left\{\frac{\partial}{\partial x}\bigg|_q+z(q)\frac{\partial}{\partial z}\bigg|_q,\frac{\partial}{\partial y}\bigg|_q\right\}
\]
es una distribucion que no es integrable, como veremos mas adelante.

\end{bookexample}
\begin{bookdefinition}{Distribucion involutiva}
...
\[
[Z_i,Z_j]\text{ esta en }\mathcal D,\qquad 1\le i,j\le k.
\]
osea

\[
[Z_{i},Z_{j}]_{q}\in \mathcal{D}_{q}\quad1\leq i,j\leq k
\]
\end{bookexercise}
...
Por \hyperref[blk:ejercicio-8-pr4]{Ejercicio 8, practico 4}, existen campos suaves $\widetilde X,\widetilde Y$ en $\mathfrak X(N)$ tales que
