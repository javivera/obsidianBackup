...
>[!Proposition] Generador infinitesimal y su suavidad
...
>Entonces $X_p\in T_pM$ para todo $p\in M$, y $X$ es un campo vectorial suave en $M$. Este campo se llama el **generador infinitesimal** del subgrupo monoparamétrico $\theta$.
>
>>[!Proof]-
