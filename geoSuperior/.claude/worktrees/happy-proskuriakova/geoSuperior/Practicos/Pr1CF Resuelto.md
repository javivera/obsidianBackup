...
>>[!Proof]-
>>**7.a** Las cartas de casquetes y las cartas estereográficas definen la misma estructura suave porque sus cambios de coordenadas son suaves. En efecto:
>>- una carta de casquete se escribe mediante proyección a $\mathbb R^n$ y una raíz cuadrada;
>>- una carta estereográfica se escribe mediante cocientes racionales;
>>- al componer unas con otras, aparecen funciones racionales y raíces sobre dominios donde están bien definidas.
>>Todas esas expresiones son $C^\infty$ en sus dominios. Luego ambas familias de cartas son compatibles.
>>
