...
>>
>>1. **Linealidad.** Si $f,g\in C^\infty(M)$ y $\lambda\in\mathbb{R}$, entonces $$((f+\lambda g)\circ\varphi^{-1})=(f\circ\varphi^{-1})+\lambda(g\circ\varphi^{-1})$$y por linealidad de la derivada parcial en $\mathbb{R}^n$, $$\left.\frac{\partial}{\partial x_i}\right|_p(f+\lambda g)=\left.\frac{\partial}{\partial x_i}\right|_p(f)+\lambda\left.\frac{\partial}{\partial x_i}\right|_p(g).$$
>>
